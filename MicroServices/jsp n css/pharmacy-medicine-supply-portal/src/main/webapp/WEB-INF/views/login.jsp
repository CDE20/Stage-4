...
<body style="background-color:	#989898;" >
  ...
  <ul class="navbar-nav">
    <li class="nav-item">
      <a class="nav-link" href="#">STAR PHARMACEUTICALS</a>
    </li>
...
<!--                   -->
	 ...
	 <div class="container-fluid">
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <form:form action="/user/homepage" modelAttribute="usercredentials" method="post">
                                    <div class="form-group mb-3">
                                        <input id="userid" type="text" name="userid" placeholder="Username" required="" autofocus="" class="form-control rounded-pill border-0 shadow-sm px-4">
                                    </div>
                                    <div class="form-group mb-3">
                                    ...
                                    <button  type="submit" name="submit" class="btn btn-warning btn-block text-uppercase mb-2 rounded-pill shadow-sm">Login</button>
  ...
  <div class="flip-card-inner">
    <div class="flip-card-front">
      <img src="https://images.unsplash.com/photo-1563213126-a4273aed2016?ixlib=rb-1.2.1&ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&auto=format&fit=crop&w=1350&q=80" alt="Avatar" style="width:400px;height:400px;">
    </div>
    <div class="flip-card-back">
        <h1>mecidine</h1> 
    </div>

...
<body>
 ...
 <nav class="navbar navbar-dark bg-dark" style="margin-left: 20px;">
        <a class="navbar-brand" href="#">
          ...
          Star Pharmacy</a>
        <form action="/user/login" method="GET"><button type="button float-right" class="btn btn-outline-light">sign in</button></form>
      </nav>                    <!-- Demo content-->
                    <div class="container">
                            ...
                            <div class="col-lg-10 col-xl-7 mx-auto">
                                ...
                                <p   class="text mb-4">you have loggout successfully</p>
								  
                                 <p   class="text mb-4">sign in again</p>		
                                 <a  href="/user/login"><button type="button" class="btn btn-warning">Sign in</button></a>								 

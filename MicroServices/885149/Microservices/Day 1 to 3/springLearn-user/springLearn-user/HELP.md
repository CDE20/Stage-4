...
* The original package name 'com.example.microservices.spring.learn.springLearn-user' is invalid and this project uses 'com.example.microservices.spring.learn.springLearnuser' instead.
